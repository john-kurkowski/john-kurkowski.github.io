...
coordinating them will drain your limited attention and time. Some are actively
distracting.[^2] Skip them for now.

Rather, if you chip away at your big task for 20 minutes, your body will likely
want to continue. This is the same strategy as [_don't break the chain_], and
[_systems over goals_]. The big rock task will have meaningful progress for the
day. Even if you don't finish the task, you'll end the day a lot more satisfied,
with something to show, versus if you hadn't touched the task at all.
...
[^2]:
    [Studies show] background music is never a net gain for productivity.
    However, I'm not saying never listen to music while doing other things. I
    believe it is sometimes better to feel good then be good at all times. All
    work and no play makes you an automaton, and all that.
