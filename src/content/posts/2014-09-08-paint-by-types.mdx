...
<blockquote>
  ...
  <pre>    a -> a -> a</pre>
  <p>
    Remember that <code>a</code> is a type variable which can stand for any
    type. What sorts of functions have this type?
  </p>
</blockquote>
...
<blockquote>
  <p>
    So, what functions actually could have this type? Actually, there are only
    two!
  </p>
  <pre>
    {`    f1 :: a -> a -> a`}
...
> Iâm terrible at programming. Iâm a bad programmer and not very bright. Haskell
...
<figure>
  <img
    src={paintByNumbers.src}
    width='61%'
    height='auto'
    alt='Paint By Numbers example'
  />
  <figcaption>
    “I wonder what NPEs are going to happen today?” Worry not.
  </figcaption>
</figure>
