...
<figure>
  <img src={pagespeedInsights.src} width="50%" height="auto" alt="PageSpeed Insights - screenshot"/>
</figure>
...
<figure>
  <a href="http://codepen.io/ericrasch/details/zjDBx">
    <img src={restyleSelectBox.src} width="40%" height="auto" alt="Restyled <select> box - screenshot"/>
  </a>
