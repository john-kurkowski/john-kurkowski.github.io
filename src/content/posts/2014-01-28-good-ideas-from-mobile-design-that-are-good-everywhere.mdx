...
image: ./pagespeed_insights.png
imageAlt: PageSpeed Insights - screenshot
---
...
audience. Keep the following ideas in mind. Benefit both desktop and mobile
customers.
...
<ul>
  <li>
    ...
    <ol>
      <li>
        <a href='#size-tap-targets-appropriately'>
          {'Size Tap Targets Appropriately'}
        </a>
      </li>
      <li>
        <a href='#avoid-plugins'>{'Avoid Plugins'}</a>
      </li>
      <li>
        <a href='#configure-the-viewport'>{'Configure the Viewport'}</a>
      </li>
      <li>
        <a href='#use-legible-font-sizes'>{'Use Legible Font Sizes'}</a>
      </li>
    </ol>
  </li>
  <li class='mt-4'>
    ...
    <ol start='5'>
      <li>
        <a href='#remove-half'>
          {'Remove Half Your Content, Then Remove Half Of What’s Left'}
        </a>
      </li>
      <li>
        <a href='#avoid-modes'>
          {'Avoid Interaction & Modes: Hovers, Menus, Modals'}
        </a>
      </li>
      <li>
        <a href='#avoid-inner-scrolls'>
          {'Avoid Interaction & Modes: Inner Scrolls'}
        </a>
      </li>
      <li>
        <a href='#dont-restyle-form-inputs--scrollbars'>
          {'Don’t Restyle Form Inputs & Scrollbars'}
        </a>
      </li>
      <li>
        <a href='#no-really-show-the-data'>{'No, Really, Show the Data'}</a>
      </li>
    </ol>
  </li>
</ul>
...
Pour your blood and sweat into making a web page, and you’ll internalize its
flow. You constantly test its dark corners, probably more than your users. Doing
this testing, you get adept at navigating to all your content’s links. All this
...
myriad widgets and ads, or internalize the specifics of your web site. There are
a million other web sites they have to keep up with. Your text is not special.
...
is a _cost_, physical and mental.
...
**Solution:** data-hiding interaction and modes are costly to users, so avoid
them. Instead,
...
- Use direct and consistent text and symbology, so the user knows what they’re
...
- If you absolutely must give the middle finger to your users by introducing a
  mode or interaction, prefer self-evident scrolling and hyperlinks[^3]. At the
...
<figure>
  <div class='col-gap-4 grid grid-cols-2'>
    <img src={gmailsNewCompose.src} alt="Gmail's New Compose - screenshot" />
    <img src={spotifyDesktop.src} alt="Spotify's desktop app - screenshot" />
  </div>
  <figcaption>
    In Gmail’s New Compose, you can scroll the text of the email you’re
    composing independently of your list of inbox messages. In Spotify’s desktop
    client, there are 3 inner scrolls from left to right: a list of music
    sources, the currently browsed music, and a friend news feed.
  </figcaption>
</figure>
...
and scrollbars. Their style is tightly locked into web browsers and perhaps the
...
focus on valuable content, rather than distracting you and your users with style
...
<figure>
  <a href='http://codepen.io/ericrasch/details/zjDBx'>
    <img
      src={restyleSelectBox.src}
      width='40%'
      height='auto'
      alt='Restyled <select> box - screenshot'
    />
  </a>
...
Web users deal with forms and scrollbars all day. Why must yours look and work
...
particularly with tips [#4](#use-legible-font-sizes), [#5](#remove-half), and
...
[^2]:
    [This case study of Southwest Airlines’ desktop and mobile
