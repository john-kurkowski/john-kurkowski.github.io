...
> quiz about music theory rather than a blind audition.[^1]
...
assessment were promising for hiring, we still could've done better.[^2]
...
difficult.[^3] I felt beggars couldn't be choosers.
...
[^1]:
    I showed this quote to a friend who played and hired for a nationally
    touring symphony. She laughed, the blind audition is judged unfairly, each
    member of the loop weighing in with a temperamental bias, maybe having a bad
    day themselves. I guess no industry escapes the quirks of hiring people to
    join a team for years based on getting to know them for a few hours. I still
    think the quote is directionally correct for software developer interviews
    the industry needs to aspire to.
