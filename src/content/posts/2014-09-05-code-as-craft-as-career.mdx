...
<table class='text-center'>
  <thead>
    <tr class='bg-gray-100'>
      ...
      <th class='border-b border-l border-gray-500 px-4 py-2'>
        {`Good Enough, Cheap`}
      </th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td class='border-b border-l border-gray-500 px-4 py-2'>{`Ikea`}</td>
    </tr>
    <tr>
      <td class='border-b border-gray-500 px-4 py-2'>
        {`Ornate lettering by a Typesetter`}
      </td>
      <td class='border-b border-l border-gray-500 px-4 py-2'>
        {`Adobe Illustrator & a commodity laser printer`}
      </td>
    </tr>
    <tr>
      <td class='border-gray-500 px-4 py-2'>{`Code`}</td>
      <td class='border-l border-gray-500 px-4 py-2'>{`???`}</td>
    </tr>
  </tbody>
</table>
